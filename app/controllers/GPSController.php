...
class GPSController extends \BaseController {
	...
	public function sendTest()
	{
        ...
        if($lock->statusCode != 200){
            return json_encode(array('text' => 'Error','msg' => 'Error de comunicación con el dispositivo, Por favor comuníquese con Servicio Técnico (Error Code #03)','type' => 'status'));
        }
        sleep(10);
        ...
        if((time()-strtotime($data->created_at)) <10){
            ...
            if($unlock->statusCode != 200){
                return json_encode(array('text' => 'Error','msg' => 'Error de comunicación con el dispositivo, Por favor comuníquese con Servicio Técnico (Error Code #03)','status' => 'error'));
            }
            sleep(10);
            ...
            if((time()-strtotime($data->created_at)) <10) {
                ...
                return json_encode(array('text' => 'Error','msg' => 'Error de comunicación con el dispositivo, Por favor comuníquese con Servicio Técnico (Error Code #02)','status' => 'error'));
            }
        }
        else{
            return json_encode(array('text' => 'Error','msg' => 'Error de comunicación con el dispositivo, Por favor comuníquese con Servicio Técnico (Error Code #01)','status' => 'error'));
        }
	}
	...
	public function sendGetitback()
	{
		...
		if((time()-strtotime($data->created_at)) <10){
			...
			return json_encode(array('text' => 'Error','msg' => 'Error al consultar estado del dispositivo, Por favor comuníquese con Servicio Técnico (Error Code #01)','status' => 'error'));
		}
	}
